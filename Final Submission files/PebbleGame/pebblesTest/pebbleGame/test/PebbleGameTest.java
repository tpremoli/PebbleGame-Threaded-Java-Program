...
public class PebbleGameTest {
    ...
    public void writePebblesToFile() throws IOException {
        ...
        List<String> expectedContents = Files.readAllLines(Paths.get("./pebbleGame/test/test_writePebblesToFile.txt"));
    ...
    public void writeDiscardToFile() throws IOException {
        ...
        List<String> actualContents = Files.readAllLines(Paths.get("./Player -1.txt"));
        List<String> expectedContents = Files.readAllLines(Paths.get("./pebbleGame/test/test_writeDiscardToFile.txt"));
    ...
    public void initialWrite() throws IOException {
        ...
        List<String> actualContents = Files.readAllLines(Paths.get("./Player -1.txt"));
        List<String> expectedContents = Files.readAllLines(Paths.get("./pebbleGame/test/test_initialWrite.txt"));
